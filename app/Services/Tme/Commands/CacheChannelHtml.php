...
namespace App\Services\Tme\Commands;

use App\Services\Tme\Command;
use App\Services\Tme\Models\TgStatChannel;
use App\Services\Tme\TgStatService;
...
class CacheChannelHtml extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tme:saveChannelHtml {--slug= : channel slug} {--id= : channel_id} {--name= : filename} {--path=fetch : path to save file}';
